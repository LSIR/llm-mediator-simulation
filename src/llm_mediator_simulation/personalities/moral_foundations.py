...
class MoralFoundation(Enum):
    ...
    """
    CARE_HARM = MoralFoundationValue("care/harm",
    ...
    SANCTITY_DEGRADATION_PURITY = MoralFoundationValue("sanctity/degradation (v1) - purity (v2)",
                                                       "wary of a diverse array of symbolic objects and threats",
                                                       "avoiding bodily and spiritual contamination and degradation")

    LIBERTY_OPPRESSION = MoralFoundationValue("liberty/oppression",
                                              "willing to notice and resent any sign of attempted domination",
                                              None) # Liberty/Oppression is not part of Table 2 of 10.1037/pspp0000470