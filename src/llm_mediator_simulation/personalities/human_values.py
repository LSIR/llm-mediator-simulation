...
class BasicHumanValues(Enum):
    ...
    SELF_DIRECTION_ACTION = BasicHumanValuesValue("self-direction action",
                                                  "freedom to determine one's own actions")

    STIMULATION = BasicHumanValuesValue("stimulation",
                                        "excitement, novelty, and change")

    HEDONISM = BasicHumanValuesValue("hedonism",
                                     "pleasure and sensuous gratification")

    ACHIEVEMENT = BasicHumanValuesValue("achievement",
                                        "success according to social standards")

    POWER_DOMINANCE = BasicHumanValuesValue("power dominance",
                                            "power through exercising control over people")

    POWER_RESOURCES = BasicHumanValuesValue("power resources",
                                            "power through control of material and social resources")

    FACE = BasicHumanValuesValue("face",
                                 "security and power through maintaining one's public image and avoiding humiliation")

    SECURITY_PERSONAL = BasicHumanValuesValue("security personal",
                                              "safety in one's immediate environment")

    SECURITY_SOCIETAL = BasicHumanValuesValue("security societal",
                                              "safety and stability in the wider society")

    TRADITION = BasicHumanValuesValue("tradition",
                                      "maintaining and preserving cultural, family, or religious traditions")

    CONFORMITY_RULES = BasicHumanValuesValue("conformity rules",
                                             "compliance with rules, laws, and formal obligations")

    CONFORMITY_INTERPERSONAL = BasicHumanValuesValue("conformity interpersonal",
                                                     "avoidance of upsetting or harming other people")

    HUMILITY = BasicHumanValuesValue("humility",
                                     "recognizing one's insignificance in the larger scheme of things")

    BENEVOLENCE_DEPENDABILITY = BasicHumanValuesValue("benevolence dependability",
                                                      "being a reliable and trustworthy member of the ingroup")

    BENEVOLENCE_CARING = BasicHumanValuesValue("benevolence caring",
                                               "devotion to the welfare of ingroup members")

    UNIVERSALISM_CONCERN = BasicHumanValuesValue("universalism concern",
                                                 "commitment to equality, justice, and protection for all people")

    UNIVERSALISM_NATURE = BasicHumanValuesValue("universalism nature",
                                                "preservation of the natural environment")

    UNIVERSALISM_TOLERANCE = BasicHumanValuesValue("universalism tolerance",
